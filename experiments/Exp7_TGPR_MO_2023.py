# Auto-generated runner for TGPR_MO.
# Run with: python Exp7_TGPR_MO_2023.py
...
_EXPERIMENTS_METHOD_NAME = "TGPR_MO"
...
all_results = batch_experiments.run_tgpr_mo_suite(config_path=EXPERIMENTS_DIR / 'config.yaml')
