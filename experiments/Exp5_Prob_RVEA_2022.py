# Auto-generated runner for Prob_RVEA.
# Run with: python Exp5_Prob_RVEA_2022.py
...
_EXPERIMENTS_METHOD_NAME = "Prob_RVEA"
...
all_results = batch_experiments.run_prob_rvea_suite(config_path=EXPERIMENTS_DIR / 'config.yaml')
