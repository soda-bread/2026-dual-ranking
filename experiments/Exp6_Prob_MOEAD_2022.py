# Auto-generated runner for Prob_MOEAD.
# Run with: python Exp6_Prob_MOEAD_2022.py
...
_EXPERIMENTS_METHOD_NAME = "Prob_MOEAD"
...
all_results = batch_experiments.run_prob_moead_suite(config_path=EXPERIMENTS_DIR / 'config.yaml', max_workers=8)
